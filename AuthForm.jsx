...
const AuthForm = () => {
  ...
  // Apply persisted theme on mount and when toggled
  React.useEffect(() => {
    if (isDark) {
  ...
  // If role is organization, keep the view on Login only (no signup in AuthForm)
  React.useEffect(() => {
    if (userRole === 'organization' && isActive) {
      setIsActive(false);
    }
  }, [userRole, isActive]);
  ...
  const handleRegisterClick = () => {
    // Disable signup screen in AuthForm for organization/NGO
    if (userRole === 'organization') return;
    setIsActive(true);
  };
    ...
    <>
      ...
      <div className={`container ${isActive ? 'active' : ''}`}>
        ...
        <div className="form-box Login">
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '20px', padding: '14px 14px 0' }}>
          ...
          <form onSubmit={handleSubmit}>
            <div className="form-field" style={formFieldStyle}>
              <label style={{ display: 'block', marginBottom: '8px', fontSize: '16px', color: '#6c9ac9ff', fontWeight: '600', textAlign: 'left' }}>Username</label>
            ...
            <div className="form-field" style={formFieldStyle}>
              <label style={{ display: 'block', marginBottom: '8px', fontSize: '16px', color: '#6c9ac9ff', fontWeight: '600', textAlign: 'left' }}>Password</label>
              <div className="input-box">
                <input
                  type="password"
                  name="password"
  ...
  {/* Register Form (hidden for organization role) */}
  {userRole !== 'organization' && (
  <div className="form-box Register">
          ...
          <form onSubmit={handleRegisterSubmit}>
            {userRole === 'organization' ? (
              <>
                <div className="form-field" style={formFieldStyle}>
                  <label style={{ display: 'block', marginBottom: '8px', fontSize: '16px', color: '#6c9ac9ff', fontWeight: '600', textAlign: 'left' }}>Organization Name</label>
                  <div className="input-box">
                    <input 
                      type="text" 
                      name="username"
                ...
                <div className="form-field" style={formFieldStyle}>
                  <label style={{ display: 'block', marginBottom: '8px', fontSize: '16px', color: '#6c9ac9ff', fontWeight: '600', textAlign: 'left' }}>Registration Number</label>
                  <div className="input-box">
                    <input 
                      type="text" 
                ...
                <div className="form-field" style={formFieldStyle}>
                  <label style={{ display: 'block', marginBottom: '8px', fontSize: '16px', color: '#6c9ac9ff', fontWeight: '600', textAlign: 'left' }}>Website (Optional)</label>
                  <div className="input-box">
                    <input 
                      type="url" 
                      name="website"
              ...
              <>
                <div className="form-field" style={formFieldStyle}>
                  <label style={{ display: 'block', marginBottom: '8px', fontSize: '16px', color: '#6c9ac9ff', fontWeight: '600', textAlign: 'left' }}>Full Name</label>
                  <div className="input-box">
                    <input 
                      type="text" 
                      name="username"
                ...
                <div className="form-field" style={formFieldStyle}>
                  <label style={{ display: 'block', marginBottom: '8px', fontSize: '16px', color: '#6c9ac9ff', fontWeight: '600', textAlign: 'left' }}>Profession/Specialization</label>
                  <div className="input-box">
                    <input
                      type="text"
                      name="profession"
                ...
                <div className="form-field" style={formFieldStyle}>
                  <label style={{ display: 'block', marginBottom: '8px', fontSize: '16px', color: '#6c9ac9ff', fontWeight: '600', textAlign: 'left' }}>Professional License/ID (Optional)</label>
                  <div className="input-box">
                    <input 
                      type="text" 
                      name="license"
              ...
              <div className="form-field" style={formFieldStyle}>
                <label style={{ display: 'block', marginBottom: '8px', fontSize: '16px', color: '#6c9ac9ff', fontWeight: '600', textAlign: 'left' }}>
            ...
            <div className="form-field" style={formFieldStyle}>
              <label style={{ display: 'block', marginBottom: '8px', fontSize: '16px', color: '#6c9ac9ff', fontWeight: '600', textAlign: 'left' }}>Email</label>
              <div className="input-box">
                <input 
                  type="email" 
                  name="email"
            ...
            {(userRole === 'donor' || userRole === 'helper' || userRole === 'receiver' || userRole === 'organization') && (
              <div className="form-field" style={formFieldStyle}>
                <label style={{ display: 'block', marginBottom: '8px', fontSize: '16px', color: '#6c9ac9ff', fontWeight: '600', textAlign: 'left' }}>Phone Number</label>
                <div className="input-box">
                  <input 
                    type="tel" 
                    name="phone"
            ...
            {userRole === 'admin' && (
              <div className="form-field" style={formFieldStyle}>
                <label style={{ display: 'block', marginBottom: '8px', fontSize: '16px', color: '#6c9ac9ff', fontWeight: '600', textAlign: 'left' }}>Admin Code</label>
                <div className="input-box">
                  <input 
                    type="text" 
                    name="adminCode"
            ...
            {userRole === 'receiver' && (
              <>
                <div className="form-field" style={formFieldStyle}>
                  <label style={{ display: 'block', marginBottom: '8px', fontSize: '16px', color: '#6c9ac9ff', fontWeight: '600', textAlign: 'left' }}>Full Address</label>
                  <div className="input-box">
                    <input
                      type="text"
                      name="address"
                ...
                <div className="form-field" style={formFieldStyle}>
                  <label style={{ display: 'block', marginBottom: '8px', fontSize: '16px', color: '#6c9ac9ff', fontWeight: '600', textAlign: 'left' }}>Aadhar Number (KYC)</label>
                  <div className="input-box">
                    <input 
                      type="text" 
                      name="aadhar"
